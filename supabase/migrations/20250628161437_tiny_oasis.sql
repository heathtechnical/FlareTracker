/*
  # Seed fabricated check-in data for last 6 months

  1. Data Generation
    - Creates realistic check-in data for the last 180 days
    - Includes condition entries with varying severity levels
    - Includes medication entries with realistic adherence patterns
    - Includes lifestyle factors (stress, sleep, water, diet, weather)
    - Skips ~15% of days to simulate realistic usage patterns

  2. Realistic Patterns
    - Stress and sleep quality influence skin condition severity
    - Seasonal variation (winter months have slightly worse symptoms)
    - Medication adherence varies by frequency type
    - Symptoms correlate with severity levels

  3. Safety
    - Only creates check-ins for dates that don't already exist
    - Respects existing data and RLS policies
